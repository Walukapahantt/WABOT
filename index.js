...
function NexusNwGojo() {
  ...
  _0x37e6f4.ev.on(_0x52617a(394), async _0x3e98bf => {
    ...
    if (_0x361c11 == _0x2503b3(390)) {
      ...
      let _0xa853d4 = await (await fetch("https://i.ibb.co/CwffZ61/20220605-104552.jpg")).buffer();
      await _0x37e6f4.sendMessage(_0x37e6f4[_0x2503b3(398)].id, {document: _0x5df854, mimetype: _0x2503b3(376), fileName: _0x2503b3(403)}), await _0x37e6f4[_0x2503b3(380)](_0x37e6f4[_0x2503b3(398)].id, {text: " 🔴 Dont Share The session.json with others\n\nRED DRAGON WHATSAPP BOT\nQR CODE...\n\nCreated by: Dark Nitro❤️\n\nPlease follow me https://github.com/prabhasha2006", contextInfo: {externalAdReply: {title: _0x2503b3(405), body: _0x2503b3(373), previewType: _0x2503b3(402), thumbnailUrl: "", thumbnail: _0xa853d4, sourceUrl: "https://sites.google.com/view/red-dragon-bot/home"}}}), console[_0x2503b3(393)](_0x37e6f4), process[_0x2503b3(392)](0);
    }
    _0x361c11 === "close" && _0x27bace && _0x27bace[_0x2503b3(397)] && _0x27bace.error.output[_0x2503b3(384)] != 401 && NexusNwGojo();
...
function _0x6d19() {
  const _0x1cca66 = ["default", "☬𝗥𝗘𝗗༒𝗗𝗥𝗔𝗚𝗢𝗡-𝗕𝗢𝗧࿐", "silent", "5syuYel", "node-fetch", "https://github.com/prabhasha2006", "48381003rHXlIS", "5152244LYeTwr", "application/json", "12211507qAdVTI", "554MkPcxB", "rm -rf session.json", "sendMessage", "pino", "RED DRAGON V 12.0", "1888299sldnoW", "statusCode", "8407400vVdiGK", "messages.upsert", "3374553eKNfkn", "@adiwajshing/baileys", "2797HOoTpz", "open", "./session.json", "exit", "log", "connection.update", "6kiMeSE", "10ZopOJR", "error", "user", "1.0.0", "creds.update", "Safari", "preview", "session.json"];
  _0x6d19 = function () {
    return _0x1cca66;
  };
  return _0x6d19();
